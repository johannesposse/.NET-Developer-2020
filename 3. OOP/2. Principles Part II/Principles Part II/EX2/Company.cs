...
namespace EX2
{
    class Company : Bank, IintrestRate
    {
        ...
        public Company(string name, bool depositAccount, bool loanAccount, bool mortgageAccount) : base(depositAccount, loanAccount, mortgageAccount)
        {
            this.name = name;
        }
