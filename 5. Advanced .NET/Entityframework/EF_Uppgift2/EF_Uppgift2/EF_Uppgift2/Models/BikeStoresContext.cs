...
namespace EF_Uppgift2.Models
{
    public partial class BikeStoresContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=BikeStores;Integrated Security=True;").UseLazyLoadingProxies();
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ItemId })
                    .HasName("PK__order_it__837942D43651FDD5");
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61644D23F044")
                    .IsUnique();
            ...
            modelBuilder.Entity<Stock>(entity =>
            {
                entity.HasKey(e => new { e.StoreId, e.ProductId })
                    .HasName("PK__stocks__E68284D378DC3118");
